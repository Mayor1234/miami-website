...
const BannerDrop = () => {
  return (
    <div className="max-w-5xl mx-auto flex flex-col gap-10 lg:gap-4 lg:flex-row justify-center items-center h-auto lg:h-60 bg-[#1890ff] text-white py-8 px-8 -mt-20 z-50">
